...
@section('titre', 'Nouvelle catégorie de sortie')
...
<div class="page-head">
    <h1>Nouvelle catégorie de sortie</h1>
    <p>Ajouter un type de dépense disponible à la saisie.</p>
</div>

<div class="form-card">
    <form action="{{ route('categories-sorties.store') }}" method="POST">
        @csrf
        <div class="form-row">
            <label>Libellé</label>
            <input type="text" name="libelle" placeholder="Exemple : Transport" value="{{ old('libelle') }}" required>

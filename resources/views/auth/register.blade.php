...
<div class="auth-split">
    <div class="auth-brand">
        ...
        <div class="quote">
            <span class="mark">“</span>Un accès par personne, un rôle par responsabilité — la traçabilité commence ici.
        </div>
        <div class="footnote">La création de compte peut être réservée à l'administrateur selon vos règles internes.</div>
    </div>

    <div class="auth-form-side">
        <div class="auth-card">
            <h2>Créer un compte</h2>
            <p class="sub">Renseignez vos informations pour accéder à l'application.</p>
